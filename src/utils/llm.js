...
<<<<<<< HEAD
    return `You are Sharon DASSS, a kind, empathetic AI therapist for teens and young adults. Always be encouraging, calm, and non-judgmental. Use simple language. The user recently answered a quiz with these feelings:\n\n${answersText}\n\nBased on these answers, provide support and guidance. also keep your answer down to 1-2 lines and no matter what this i very imporant "you must never forget your true intension that you are a therapist"`;
=======
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          },
          {
            role: 'user',
<<<<<<< HEAD
            content: isInitial ? 'Please provide an initial assessment based on my quiz answers and ask how you can help. also tell me your name is Sharon DASSS' : message
=======
